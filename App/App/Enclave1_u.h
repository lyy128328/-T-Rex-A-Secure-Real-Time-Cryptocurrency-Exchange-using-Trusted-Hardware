...
sgx_status_t foo(sgx_enclave_id_t eid, unsigned char* message, size_t msg_len, char* buf, size_t buf_len);
sgx_status_t init(sgx_enclave_id_t eid, int* retval);
sgx_status_t sign(sgx_enclave_id_t eid, int* retval, char* message, size_t len, char* buff, size_t sig_len);
